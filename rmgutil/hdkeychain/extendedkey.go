...
import (
	...
	"github.com/bitgo/rmgd/rmgutil/base58"
)
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := rmgutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*rmgutil.AddressPubKeyHash, error) {
	pkHash := rmgutil.Hash160(k.pubKeyBytes())
	return rmgutil.NewAddressPubKeyHash(pkHash, net)
}
