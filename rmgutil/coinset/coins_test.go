...
import (
	...
	"github.com/bitgo/rmgd/rmgutil/coinset"
...
var (
	...
	testSimpleCoinTxValue0            = rmgutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = rmgutil.NewTxFromBytes(testSimpleCoinTxBytes)
