...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		encoded string
		valid   bool
		result  rmgutil.Address
		f       func() (rmgutil.Address, error)
		net     *chaincfg.Params
	}{
		// Positive P2PKH tests.
		{
			...
			valid:   true,
			result: rmgutil.TstAddressPubKeyHash(
				[ripemd160.Size]byte{
			...
			f: func() (rmgutil.Address, error) {
				pkHash := []byte{
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xc5, 0x4c, 0xe7, 0xd2, 0xa4, 0x91, 0xbb, 0x4a, 0x0e, 0x84}
				return rmgutil.NewAddressPubKeyHash(pkHash, &chaincfg.MainNetParams)
			},
		...
		},
		{
			...
			f: func() (rmgutil.Address, error) {
				pkHash := []byte{
					0x78, 0xb3, 0x16, 0xa0, 0x86, 0x47, 0xd5, 0xb7, 0x72, 0x83,
					0xe5, 0x12, 0xd3, 0x60, 0x3f, 0x1f, 0x1c, 0x8d, 0xe6, 0x8f}
				return rmgutil.NewAddressPubKeyHash(pkHash, &chaincfg.TestNet3Params)
			},
		...
		// Positive P2SH tests.
		{
			...
			valid:   true,
			result: rmgutil.TstAddressScriptHash(
				[ripemd160.Size]byte{
			...
			f: func() (rmgutil.Address, error) {
				script := []byte{
					...
					0xae}
				return rmgutil.NewAddressScriptHash(script, &chaincfg.MainNetParams)
			},
			net: &chaincfg.MainNetParams,
		},
		{
			...
			f: func() (rmgutil.Address, error) {
				hash := []byte{
					0xe8, 0xc3, 0x00, 0xc8, 0x79, 0x86, 0xef, 0xa8, 0x4c, 0x37,
					0xc0, 0x51, 0x99, 0x29, 0x01, 0x9e, 0xf8, 0x6e, 0xb5, 0xb4}
				return rmgutil.NewAddressScriptHashFromHash(hash, &chaincfg.MainNetParams)
			},
			net: &chaincfg.MainNetParams,
		},
		{
			...
			f: func() (rmgutil.Address, error) {
				hash := []byte{
					0xc5, 0x79, 0x34, 0x2c, 0x2c, 0x4c, 0x92, 0x20, 0x20, 0x5e,
					0x2c, 0xdc, 0x28, 0x56, 0x17, 0x04, 0x0c, 0x92, 0x4a, 0x0a}
				return rmgutil.NewAddressScriptHashFromHash(hash, &chaincfg.TestNet3Params)
			},
			net: &chaincfg.TestNet3Params,
		},
		...
		// Positive P2PK tests.
		{
			...
			valid:   true,
			result: rmgutil.TstAddressPubKey(
				[]byte{
					0x02, 0x19, 0x2d, 0x74, 0xd0, 0xcb, 0x94, 0x34, 0x4c, 0x95,
					0x69, 0xc2, 0xe7, 0x79, 0x01, 0x57, 0x3d, 0x8d, 0x79, 0x03,
					0xc3, 0xeb, 0xec, 0x3a, 0x95, 0x77, 0x24, 0x89, 0x5d, 0xca,
					0x52, 0xc6, 0xb4},
				rmgutil.PKFCompressed, chaincfg.MainNetParams.PubKeyHashAddrID),
			f: func() (rmgutil.Address, error) {
				serializedPubKey := []byte{
					...
					0xc3, 0xeb, 0xec, 0x3a, 0x95, 0x77, 0x24, 0x89, 0x5d, 0xca,
					0x52, 0xc6, 0xb4}
				return rmgutil.NewAddressPubKey(serializedPubKey, &chaincfg.MainNetParams)
			},
			net: &chaincfg.MainNetParams,
		},
		{
		...
		},
		{
			...
			result: rmgutil.TstAddressPubKey(
				...
				rmgutil.PKFUncompressed, chaincfg.MainNetParams.PubKeyHashAddrID),
			f: func() (rmgutil.Address, error) {
				serializedPubKey := []byte{
					0x04, 0x11, 0xdb, 0x93, 0xe1, 0xdc, 0xdb, 0x8a, 0x01, 0x6b,
					0x49, 0x84, 0x0f, 0x8c, 0x53, 0xbc, 0x1e, 0xb6, 0x8a, 0x38,
		...
		},
		{
			...
			result: rmgutil.TstAddressPubKey(
				...
				rmgutil.PKFHybrid, chaincfg.MainNetParams.PubKeyHashAddrID),
			f: func() (rmgutil.Address, error) {
				serializedPubKey := []byte{
					0x06, 0x19, 0x2d, 0x74, 0xd0, 0xcb, 0x94, 0x34, 0x4c, 0x95,
					0x69, 0xc2, 0xe7, 0x79, 0x01, 0x57, 0x3d, 0x8d, 0x79, 0x03,
		...
		},
		{
			...
			result: rmgutil.TstAddressPubKey(
				[]byte{
					...
					0xc3, 0xeb, 0xec, 0x3a, 0x95, 0x77, 0x24, 0x89, 0x5d, 0xca,
					0x52, 0xc6, 0xb4},
				rmgutil.PKFCompressed, chaincfg.TestNet3Params.PubKeyHashAddrID),
			f: func() (rmgutil.Address, error) {
				serializedPubKey := []byte{
					0x02, 0x19, 0x2d, 0x74, 0xd0, 0xcb, 0x94, 0x34, 0x4c, 0x95,
					0x69, 0xc2, 0xe7, 0x79, 0x01, 0x57, 0x3d, 0x8d, 0x79, 0x03,
					0xc3, 0xeb, 0xec, 0x3a, 0x95, 0x77, 0x24, 0x89, 0x5d, 0xca,
					0x52, 0xc6, 0xb4}
				return rmgutil.NewAddressPubKey(serializedPubKey, &chaincfg.TestNet3Params)
			},
			net: &chaincfg.TestNet3Params,
		},
		{
		...
		},
		{
			...
			result: rmgutil.TstAddressPubKey(
				[]byte{
					...
					0x8b, 0x64, 0xf9, 0xd4, 0xc0, 0x3f, 0x99, 0x9b, 0x86, 0x43,
					0xf6, 0x56, 0xb4, 0x12, 0xa3},
				rmgutil.PKFUncompressed, chaincfg.TestNet3Params.PubKeyHashAddrID),
			f: func() (rmgutil.Address, error) {
				serializedPubKey := []byte{
					0x04, 0x11, 0xdb, 0x93, 0xe1, 0xdc, 0xdb, 0x8a, 0x01, 0x6b,
					0x49, 0x84, 0x0f, 0x8c, 0x53, 0xbc, 0x1e, 0xb6, 0x8a, 0x38,
		...
		},
		{
			...
			result: rmgutil.TstAddressPubKey(
				[]byte{
					...
					0x76, 0x83, 0x01, 0x60, 0xc6, 0xd2, 0xeb, 0x5e, 0x6a, 0x4c,
					0x44, 0xd3, 0x3f, 0x45, 0x3e},
				rmgutil.PKFHybrid, chaincfg.TestNet3Params.PubKeyHashAddrID),
			f: func() (rmgutil.Address, error) {
				serializedPubKey := []byte{
					0x06, 0x19, 0x2d, 0x74, 0xd0, 0xcb, 0x94, 0x34, 0x4c, 0x95,
					0x69, 0xc2, 0xe7, 0x79, 0x01, 0x57, 0x3d, 0x8d, 0x79, 0x03,
	...
	for _, test := range tests {
		...
		decoded, err := rmgutil.DecodeAddress(test.addr, test.net)
		...
		if err == nil {
			...
			case *rmgutil.AddressPubKeyHash:
				saddr = rmgutil.TstAddressSAddr(encoded)
