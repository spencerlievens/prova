...
// Tx returns a wrapped transaction (rmgutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (rmgutil.Tx) for all
...
// instead provides easy access to wrapped versions (rmgutil.Tx) of them.
