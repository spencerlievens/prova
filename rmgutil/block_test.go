...
func TestBlock(t *testing.T) {
	b := rmgutil.NewBlock(&Block100000)
	...
	wantHashStr := "a3438930bbb6ae5f63828507f3ecf4b9046e5a5bf37d01176e21172733b5ac22"
...
func TestNewBlockFromBytes(t *testing.T) {
	...
	b, err := rmgutil.NewBlockFromBytes(block100000Bytes)
	if err != nil {
...
func TestNewBlockFromBlockAndBytes(t *testing.T) {
	...
	// Create a new block from the serialized bytes.
	b := rmgutil.NewBlockFromBlockAndBytes(&Block100000, block100000Bytes)
...
func TestBlockErrors(t *testing.T) {
	...
	testErr := rmgutil.OutOfRangeError(wantErr)
	...
	_, err = rmgutil.NewBlockFromBytes(shortBytes)
	if err != io.EOF {
