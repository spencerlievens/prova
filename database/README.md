...
(http://godoc.org/github.com/bitgo/rmgd/database)
...
(https://github.com/bitgo/rmgd/tree/master/docs/json_rpc_api.md).
...
```bash
$ go get -u github.com/bitgo/rmgd/database
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/bitgo/rmgd/database#example-package--BasicUsage)
  Demonstrates creating a new database and using a managed read-write
  transaction to store and retrieve metadata.

* [Block Storage and Retrieval Example]
  (http://godoc.org/github.com/bitgo/rmgd/database#example-package--BlockStorageAndRetrieval)
