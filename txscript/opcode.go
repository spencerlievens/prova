...
const (
	...
	OP_ISSUINGKEYADD         = 0xbd // 189
	OP_ISSUINGKEYREVOKE      = 0xbe // 190
	OP_PROVISIONINGKEYADD    = 0xbf // 191
	OP_PROVISIONINGKEYREVOKE = 0xc0 // 192
	OP_VALIDATEKEYADD        = 0xc1 // 193
	OP_VALIDATEKEYREVOKE     = 0xc2 // 194
	OP_WSPKEYADD             = 0xc3 // 195
	OP_WSPKEYREVOKE          = 0xc4 // 196
...
var opcodeArray = [256]opcode{
	...
	OP_ISSUINGKEYADD:         {OP_ISSUINGKEYADD, "OP_ISSUINGKEYADD", 1, opcodeInvalid},
	OP_ISSUINGKEYREVOKE:      {OP_ISSUINGKEYREVOKE, "OP_ISSUINGKEYREVOKE", 1, opcodeInvalid},
	OP_PROVISIONINGKEYADD:    {OP_PROVISIONINGKEYADD, "OP_PROVISIONINGKEYADD", 1, opcodeInvalid},
	OP_PROVISIONINGKEYREVOKE: {OP_PROVISIONINGKEYREVOKE, "OP_PROVISIONINGKEYREVOKE", 1, opcodeInvalid},
	OP_VALIDATEKEYADD:        {OP_VALIDATEKEYADD, "OP_VALIDATEKEYADD", 1, opcodeInvalid},
	OP_VALIDATEKEYREVOKE:     {OP_VALIDATEKEYREVOKE, "OP_VALIDATEKEYREVOKE", 1, opcodeInvalid},
	OP_WSPKEYADD:             {OP_WSPKEYADD, "OP_WSPKEYADD", 1, opcodeInvalid},
	OP_WSPKEYREVOKE:          {OP_WSPKEYREVOKE, "OP_WSPKEYREVOKE", 1, opcodeInvalid},
	// Undefined opcodes.
	OP_UNKNOWN188: {OP_UNKNOWN188, "OP_UNKNOWN188", 1, opcodeInvalid},
	//gap for admin opcodes
