...
* Install the MSI available at: https://github.com/bitgo/rmgd/releases
...
btcd has a number of [configuration](http://godoc.org/github.com/bitgo/rmgd)
...
* [Using bootstrap.dat](https://github.com/bitgo/rmgd/tree/master/docs/using_bootstrap_dat.md)

<a name="NetworkConfig" />
**3.1.2 Network Configuration**<br />
* [What Ports Are Used by Default?](https://github.com/bitgo/rmgd/tree/master/docs/default_ports.md)
* [How To Listen on Specific Interfaces](https://github.com/bitgo/rmgd/tree/master/docs/configure_peer_server_listen_interfaces.md)
* [How To Configure RPC Server to Listen on Specific Interfaces](https://github.com/bitgo/rmgd/tree/master/docs/configure_rpc_server_listen_interfaces.md)
* [Configuring btcd with Tor](https://github.com/bitgo/rmgd/tree/master/docs/configuring_tor.md)
...
* [Code Contribution Guidelines](https://github.com/bitgo/rmgd/tree/master/docs/code_contribution_guidelines.md)
<a name="JSONRPCReference" />
* [JSON-RPC Reference](https://github.com/bitgo/rmgd/tree/master/docs/json_rpc_api.md)
    * [RPC Examples](https://github.com/bitgo/rmgd/tree/master/docs/json_rpc_api.md#ExampleCode)
<a name="GoPackages" />
* The btcsuite Bitcoin-related Go Packages:
    ...
    * [wire](https://github.com/bitgo/rmgd/tree/master/wire) - Implements the
	  Bitcoin wire protocol
    * [peer](https://github.com/bitgo/rmgd/tree/master/peer) -
	  Provides a common base for creating and managing Bitcoin network peers.
    * [blockchain](https://github.com/bitgo/rmgd/tree/master/blockchain) -
	  Implements Bitcoin block handling and chain selection rules
    * [txscript](https://github.com/bitgo/rmgd/tree/master/txscript) -
	  Implements the Bitcoin transaction scripting language
    * [btcec](https://github.com/bitgo/rmgd/tree/master/btcec) - Implements
