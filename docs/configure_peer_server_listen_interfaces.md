Prova allows you to bind to specific interfaces which enables you to setup
...
The following config file would configure prova to only listen on localhost for both IPv4 and IPv6:
