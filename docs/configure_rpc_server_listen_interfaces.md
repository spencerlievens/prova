Prova allows you to bind the RPC server to specific interfaces which enables you
...
The following config file would configure the rmgd RPC server to listen to all interfaces on the default port, including external interfaces, for both IPv4 and IPv6:
