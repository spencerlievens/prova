...
(http://godoc.org/github.com/bitgo/rmgd/peer)
...
```bash
$ go get -u github.com/bitgo/rmgd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/bitgo/rmgd/peer#example-package--NewOutboundPeer)
