...
var helpDescsEnUS = map[string]string{
	...
	// CreateRawAdminTransactionCmd help
	"createrawadmintransaction--synopsis": "Returns a new admin transaction on the provided thread id and provisioning the provided key.\n" +
		"The transaction input is not signed in the created transaction.",
	"createrawadmintransaction-txid":     "The input transaction id to the transaction",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"createrawadmintransaction": {(*string)(nil)},
