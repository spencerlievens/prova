...
func dbAddTxIndexEntries(dbTx database.Tx, block *rmgutil.Block, blockID uint32) error {
...
func dbRemoveTxIndexEntries(dbTx database.Tx, block *rmgutil.Block) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) ConnectBlock(dbTx database.Tx, block *rmgutil.Block, view *blockchain.UtxoViewpoint) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) DisconnectBlock(dbTx database.Tx, block *rmgutil.Block, view *blockchain.UtxoViewpoint) error {
